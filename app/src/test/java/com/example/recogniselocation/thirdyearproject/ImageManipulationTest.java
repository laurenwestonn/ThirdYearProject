...
public class ImageManipulationTest {
    ...
    public void thinPointTest() throws Exception {
        ...
        c.add(new Point(2,1));
        c.add(new Point(0, 1));
        assertFalse(ImageManipulation.skeletonisePoint(c, c.get(0), 1));
        ...
        //    [2]
        c.remove(c.size()-1);
        assertTrue(ImageManipulation.skeletonisePoint(c, c.get(0), 1));
    ...
    public void bestPointInColTest() throws Exception
    {
        ...
        assertThat(ImageManipulation.bestPointInCol(col, null), is(new Point(10,1)));
        ...
        assertThat(ImageManipulation.bestPointInCol(col, null), is(new Point(10,20)));
